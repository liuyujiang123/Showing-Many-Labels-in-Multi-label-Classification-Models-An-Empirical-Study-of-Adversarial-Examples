...
parser.add_argument('--adv_batch_size', default=2, type=int,
                    metavar='N', help='batch size 32')
parser.add_argument('--workers', default=8, type=int, metavar='N',
                    help='number of data loading workers (default: 4)')
parser.add_argument('--adv_method', default='MI-FGSM', type=str, metavar='N',
                    help='attack method: ml_cw, ml_deepfool, mla_lp, FGSM, FGM, MI-FGSM, BIM, PGD, SDA')
parser.add_argument('--model_type', default='mlgcn', type=str, metavar='N',
...
def evaluate_adv_many(state):
    ...
    for i, add_of_mean in enumerate(add_of_means):
        ...
        attack_fail_idx = np.argwhere(adv_pred_match_target == 0).flatten().tolist()
        np.save('../attack_result/mlgcn_voc2012_{}_mean_r_attack_fail_idx_{}.npy'.format(args.adv_method, add_of_mean),
                attack_fail_idx)
