#@Time      :2021/1/19 18:53
#@Author    :zhounan
#@FileName  :OneCycle.py.py
...
class OneCycle(object):
    ...
    def __init__(self, optimizer, nb, max_lr, momentum_vals=(0.95, 0.85), prcnt=10, div=10, use_cosine=False):
        # Sanity check
    ...
    def calc_lr_cosine(self):
        if self.iteration == 0:
            ...
            lr = (self.high_lr / self.div) + 0.5 * (self.high_lr - self.high_lr / self.div) * (
